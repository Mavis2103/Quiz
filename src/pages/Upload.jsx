...
const Upload = () => {
    ...
    const submitFile = () => {
        ...
        uploadFile(form, (response) => {
            resetForm();
            alert('Your lesson has been uploaded!')
        }, () => setLoading(false));
    }
    ...
    return (
        <div className="w-screen h-screen grid place-items-center">
            ...
            <div className="px-4 py-3 text-right sm:px-6">
                <button disabled={loading} onClick={submitFile} type="submit" className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 items-center">
